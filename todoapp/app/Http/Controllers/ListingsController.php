...
class ListingsController extends Controller
{
    ...
    public function edit($listings_id)
    {
        //print_r($listings_id);
        $listings = Listing::where('id',$listings_id)->first();
    ...
    */
    ...
    {
        $listings = Listing::where('id',$listings_id)->delete();
        return redirect('/');
    }   
    ...
    public function update(Request $request)
    {
        ...
        // 入力に問題がなければListingモデルを介して、作ったユーザーidとタイトルをlistingsテーブルに更新
        $listings = Listing::where('id',$request->id)->first();
        $listings->title = $request->list_name;
        $listings->save();
